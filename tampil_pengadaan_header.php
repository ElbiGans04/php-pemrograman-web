      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="tambah_pengadaan_header.php" class="btn btn-block btn-primary"> Tambah Data Pengadaan Header </a>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <a href="ubah_pengadaan_header.php?kode_pengadaan=<?= $rows['kd_pengadaan'] ?>" class="btn btn-warning btn-xs">Ubah</a>
                      <a href="delete_pengadaan_header.php?kode_pengadaan=<?= $rows['kd_pengadaan'] ?>" class="btn btn-danger btn-xs">Hapus</a>
                      </td>
                    </tr>
                  <?php
                    $i++;
